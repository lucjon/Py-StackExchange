...
class SiteDefinition(JSONModel):
	...
	transfer = ('name', 'logo_url', 'api_endpoint', 'site_url', 'description', 'icon_url', 'aliases', ('state', SiteState))
...
class UserAssociation(JSONModel):
	transfer = ('display_name', 'reputation', 'email_hash', ('user_type', UserType))
	alias = {'id': 'user_id'}
	has_endpoint = True
...
class StackAuth(object):
	...
	def sites(self):
		"""Returns information about all the StackExchanges sites currently lited on StackAuth.com"""
